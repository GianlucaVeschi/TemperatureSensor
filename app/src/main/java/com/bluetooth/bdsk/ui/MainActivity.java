...
/**
 * MainActivity needs to implement the ScanResultsConsumer so that it can receive and process data
...
public class MainActivity extends AppCompatActivity implements ScanResultsConsumer {
    ...
    /**
     * Set the text on the scan button according to whether or not scanning is being performed
     */
    ...
    private class ListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                ...
                viewHolder.text = view.findViewById(R.id.device_name);
                viewHolder.bdaddr = view.findViewById(R.id.device_mac);
